...
if (!inputStartLocation) { console.log("no start Date") }; // skip this fn from running if there is not input on the page
...
if (!inputStartLocation) { console.log("no end Date") }; // skip this fn from running if there is not input on the page
...
// if someone hits enter on the address field, don't submit the f orm
